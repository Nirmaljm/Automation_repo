...
public class ExcelUtility {
	...
	public static String getStringData(int a, int b,String sheet) throws IOException {
		f = new FileInputStream("C:\\Users\\NirmalJM\\git\\Automation_repo\\AutomationCourse\\src\\main\\resources\\TestData.xlsx"); // to give excel path
	...
	public static String getIntegerData(int a, int b,String sheet) throws IOException {
		f = new FileInputStream("C:\\Users\\NirmalJM\\git\\Automation_repo\\AutomationCourse\\src\\main\\resources\\TestData.xlsx");
		wb = new XSSFWorkbook(f);
